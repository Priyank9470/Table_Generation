...
namespace Practice_Table_Generation.Models
{
    public class TableGenetation
    {
        ...
        [RegularExpression(@"[0-9]{1,7}", ErrorMessage = "Please enter working days in between 1 to 7")]
        public int? WorkingDays { get; set; }

        [Required(ErrorMessage = "Please enter Subject per day")]
        [RegularExpression(@"[0-9]{1,9}", ErrorMessage = "Please enter Subject per day in between 1 to 9")]
    ...
    public class SubjectHours
    {
        ...
        [RegularExpression(@"^[1-9]\d*$", ErrorMessage = "Minimum value for subject hour is 1")]
